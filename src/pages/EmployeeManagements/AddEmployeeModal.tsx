          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              <input
                ...
                className="w-full rounded-lg border border-gray-500 px-3 py-2 outline-none focus:ring-1 focus:ring-slate-400 text-sm bg-gray-100 font-normal"
              />
            </FormField>
            ...
            >
              <div className="flex flex-wrap gap-3">
                {(['male', 'female'] as const).map((opt) => (
                  <label key={opt} className="inline-flex items-center gap-2 rounded-lg">
                    <input
                      type="radio"
                      value={opt}
                      {...register('gender')}
                    ...
                    />
                    <span className="text-sm">{capitalizeFirstLetter(opt)}</span>
                  </label>
                ))}
              </div>
            </FormField>
            ...
            >
              <select
                ...
                defaultValue=""
                {...register('department')}
                className="w-full rounded-lg border border-gray-400 px-3 py-2 outline-none focus:ring-1 focus:ring-slate-400 bg-gray-100 font-normal"
              >
