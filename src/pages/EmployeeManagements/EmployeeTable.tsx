  ...
  if (!isLoading && !data.length)
    return (
      <tr className="odd:bg-gray-100 even:bg-gray-50">
        <td colSpan={5} className="p-6 text-center text-slate-500 text-sm sm:text-base">
    ...
    <>
      {data.map((item, idx) => (
        <tr
          ...
          className="odd:bg-gray-100 even:bg-gray-50 border-b-2 border-gray-300 text-stone-700 font-semibold text-sm sm:text-base"
        >
  ...
  return (
    <>
      <div className="overflow-x-auto rounded-xl">
        <table className="min-w-full text-left text-sm sm:text-base font-bold">
